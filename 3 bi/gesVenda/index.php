...
<?php
    ...
    if($_POST != null){
        ...
        if($op == 'I'){
            ...
            $isql = 'insert into produtos (descricao, preco, custo, estoque, unidade) values ('. $descricao .','. $preco .','. $custo .','. $estoque.','. $unidade.')';
    ...
    <form action="index.php" method="POST">
        ...
        <div class="row">
            <div class="col-md-3 col-sm-12">
                <button type="submit" class="btn btn-primary w-100" onclick="$('#op').prop('value','I');">Cadastrar</button>
            </div>
            <div class="col-md-3 col-sm-12">
                <button type="submit" class="btn btn-primary w-100" onclick="$('#op').prop('value','A');">Alterar</button>
            </div>
            <div class="col-md-3 col-sm-12">
                <button type="submit" class="btn btn-primary w-100" onclick="$('#op').prop('value','E');">Excluir</button>
            </div>
            <div class="col-md-3 col-sm-12">
